...
SMODS.Joker({
	...
	in_pool = function(self)
		return content_runtime.get_pincher_unlock() -- do NOT replace this with G.GAME.round_resets.ante >= 3, order sets ante to 0
	end,
	mp_include = content_runtime.include_multiplayer_jokers,
	calc_dollar_bonus = function(self, card)
		local spent_index = content_runtime.get_pincher_index() + 1
		local spent = content_runtime.get_enemy_shop_spent(spent_index)
		local money = 0
