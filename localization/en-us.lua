return {
	...
	misc = {
		...
		dictionary = {
			...
			b_create_1v1_lobby = "Create 1v1 Lobby",
			b_create_group_lobby = "Create Group Lobby",
			b_create_ffa_lobby = "Create FFA Lobby",
			b_create_teams_lobby = "Create Teams Lobby",
			...
			b_kick = "Kick",
			b_beat_average_mode = "Beat Average Mode",
			b_send_team_money = "Send $5",
			b_view_all = "VIEW ALL",
			b_max_players = "Max Players",
			k_group_options = "Group Options",
			k_ffa_options = "FFA Options",
			k_team_options = "Team Options",
			k_lobby_type = "Lobby Type",
			k_highest_score = "Highest Score",
			k_beat_average = "Beat Average",
			k_your_team = "YOUR TEAM",
			k_pick_your_color = "PICK YOUR COLOR",
			k_team_settings = "TEAM SETTINGS",
			b_ffa_scoring_system = "Beat the Average (OFF = Highest Score Wins)",
