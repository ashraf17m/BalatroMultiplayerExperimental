return {
	...
	misc = {
		...
		dictionary = {
			b_spectate_match = "Spectate",
			k_role = "Role",
			k_role_player = "Player",
			k_role_spectator = "Spectator",
			...
			k_opts_timer_ownership = "Timer Ownership",
			k_opts_disable_asteroid = "Disable Asteroid",
			k_opts_timer_ownership_anyone = "First Ready",
			k_opts_timer_ownership_host = "Host Only",
