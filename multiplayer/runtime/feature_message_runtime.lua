...
local function action_eat_pizza(discards)
	...
	if MP.increment_match_pizza_discards then
		MP.increment_match_pizza_discards(discards)
	end
...
function feature_message_runtime.handle_send_phantom(key)
	action_send_phantom(key)
end

function feature_message_runtime.handle_remove_phantom(key)
	action_remove_phantom(key)
end

function feature_message_runtime.handle_speedrun()
	action_speedrun()
end

function feature_message_runtime.handle_asteroid()
	action_asteroid()
end

function feature_message_runtime.handle_magnet()
	action_magnet()
end

function feature_message_runtime.handle_magnet_response(key)
	action_magnet_response(key)
end
...
function feature_message_runtime.handle_sold_joker(player_id)
	action_sold_joker(player_id)
end

function feature_message_runtime.handle_lets_go_gambling_nemesis()
	action_lets_go_gambling_nemesis()
end

function feature_message_runtime.handle_eat_pizza(discards)
	action_eat_pizza(discards)
end

function feature_message_runtime.handle_spent_last_shop(player_id, amount)
	action_spent_last_shop(player_id, amount)
end

function feature_message_runtime.handle_jimbo_appear(pos, text)
	action_jimbo_appear(pos, text)
end

function feature_message_runtime.handle_jimbo_talk(text)
	action_jimbo_talk(text)
end

function feature_message_runtime.handle_jimbo_move(pos)
	action_jimbo_move(pos)
end

function feature_message_runtime.handle_jimbo_remove()
	action_jimbo_remove()
end
