...
local FLUSH_REFRESH_CALLBACKS = {
	...
	lobby_main_menu = function()
		return MP.refresh_lobby_main_menu
	end,
	pending_lobby_overlay = function()
		return MP.refresh_pending_lobby_overlay
	end,
	group_options_overlay = function()
		return MP.refresh_group_options_overlay
	end,
	lobby_option_failure = function()
		return MP.process_pending_lobby_option_failure
	end,
