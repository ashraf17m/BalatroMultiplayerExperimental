...
function feature_action_runtime.team_hand_level_sync(hand, level)
	...
	return Client.queue_send(MP.FEATURE_WIRE.build_team_hand_level_sync_payload(hand, level))
end
...
function feature_action_runtime.send_game_stats()
	MP.NETWORKING_INTERNAL.send_local_game_stats()
end

function feature_action_runtime.request_nemesis_stats(target_player_id)
	Client.queue_send(MP.FEATURE_WIRE.build_request_nemesis_stats_payload(target_player_id))
end
...
MP.ACTIONS.send_game_stats = feature_action_runtime.send_game_stats
MP.ACTIONS.request_nemesis_stats = feature_action_runtime.request_nemesis_stats
