...
function connection_resume.get_pending_manual_resume()
	return call_resume_method("get_pending_manual_resume")
end

function connection_resume.complete_manual_resume()
	return call_resume_method("complete_manual_resume")
end

function connection_resume.activate_runtime_match_sync_buffer()
	return call_resume_method("activate_runtime_match_sync_buffer")
end

function connection_resume.fail_manual_resume(clear_saved_files)
	return call_resume_method("fail_manual_resume", clear_saved_files)
end

function connection_resume.refresh_saved_resume_metadata(token, code, player_id)
	return call_resume_method("refresh_saved_resume_metadata", token, code, player_id)
end
