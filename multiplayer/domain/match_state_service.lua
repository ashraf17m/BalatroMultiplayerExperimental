...
function INTERNAL.extend_state(target, fields)
...
function MATCH_DOMAIN.get_default_starting_lives()
	return MP.LOBBY.config.starting_lives or MP.DEFAULT_STARTING_LIVES
end

function MATCH_DOMAIN.build_initial_round_state(starting_lives)
	return {
		ready_blind = false,
...
function MATCH_DOMAIN.build_initial_team_state(starting_lives)
	return {
...
function MATCH_DOMAIN.build_initial_economy_state()
	return {
		misprint_display = "",
		spent_total = 0,
		spent_before_shop = 0,
...
function MATCH_DOMAIN.build_initial_timer_state()
	return {
...
function MATCH_DOMAIN.build_initial_meta_state()
	return {
		ce_cache = false,
		pincher_index = -3,
...
function MATCH_DOMAIN.build_initial_enemy_tracking_state()
	return {
...
function MATCH_DOMAIN.build_initial_end_game_state()
	return {
		won = false,
	}
end
...
function MATCH_DOMAIN.build_initial_state()
	local starting_lives = MATCH_DOMAIN.get_default_starting_lives()
	local state = {}

	INTERNAL.extend_state(state, MATCH_DOMAIN.build_initial_round_state(starting_lives))
	INTERNAL.extend_state(state, MATCH_DOMAIN.build_initial_team_state(starting_lives))
	INTERNAL.extend_state(state, MATCH_DOMAIN.build_initial_economy_state())
	INTERNAL.extend_state(state, MATCH_DOMAIN.build_initial_timer_state())
	INTERNAL.extend_state(state, MATCH_DOMAIN.build_initial_meta_state())
	INTERNAL.extend_state(state, MATCH_DOMAIN.build_initial_enemy_tracking_state())
	INTERNAL.extend_state(state, MATCH_DOMAIN.build_initial_end_game_state())
