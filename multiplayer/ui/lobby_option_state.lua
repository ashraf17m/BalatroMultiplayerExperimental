...
function view_model.get_group_max_players_index(current_max_players)
	...
	return view_model.get_lobby_option_value_index(options, view_model.normalize_group_max_players(current_max_players))
		or view_model.get_lobby_option_value_index(options, view_model.normalize_group_max_players(MP.DEFAULT_GROUP_LOBBY_PLAYERS))
		or 1
end
