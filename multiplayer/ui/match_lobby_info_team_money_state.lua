...
function team_money_ui.can_send_amount(amount, max_amount)
	local normalized_amount, normalized_max = team_money_ui.normalize_amount(amount, max_amount)
	return normalized_amount >= 1 and normalized_amount <= normalized_max
end
...
function MP.clear_team_money_transfer_pending()
	return team_money_ui.clear_pending_target_row() ~= nil
end
