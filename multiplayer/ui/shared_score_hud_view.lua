...
local function format_score_int(score_int)
	return score_shared.format_score_int(score_int, "0")
end
...
local function get_cooperative_shared_display_score()
	local local_score_text = MP.get_team_local_score_text and MP.get_team_local_score_text()
...
local function get_shared_score_display_state()
	...
	if use_cooperative_score then
		...
		displayed_text = format_score_int(display_score)
	...
	if MP.GAME and MP.set_match_shared_score_text then
		MP.set_match_shared_score_text(displayed_text)
	end
