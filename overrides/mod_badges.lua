...
MP.PLATFORM.SMODS.override_known("create_mod_badges", function(create_mod_badges_ref)
	return function(obj, badges)
		create_mod_badges_ref(obj, badges)
		if not MP.PLATFORM.SMODS.are_mod_badges_disabled() and obj and obj.mp_credits then
