...
function MP.get_ruleset_selection_button_id(ruleset_key)
	return get_ruleset_selection_name(ruleset_key) .. "_ruleset_button"
end

function MP.build_ruleset_selection_buttons_data()
	return selection_utils.build_grouped_selection_buttons_data(MP.Rulesets, {
		...
		get_button_id = function(ruleset)
			return MP.get_ruleset_selection_button_id(ruleset.key)
		end,
	})
end
...
function MP.with_standard_ruleset_defaults(definition)
