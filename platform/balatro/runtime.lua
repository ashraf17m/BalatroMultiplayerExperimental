...
local singleplayer_loaded = MP.PLATFORM.SMODS.load_mod_file("platform/balatro/runtime_singleplayer.lua", { required = true })
if singleplayer_loaded == nil then return nil end
