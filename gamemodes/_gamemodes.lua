...
function MP.get_gamemode_selection_button_id(gamemode_key)
	return get_gamemode_selection_name(gamemode_key) .. "_gamemode_button"
end

function MP.build_gamemode_selection_buttons_data()
	return selection_utils.build_grouped_selection_buttons_data(MP.Gamemodes, {
		...
		get_button_id = function(gamemode)
			return MP.get_gamemode_selection_button_id(gamemode.key)
		end,
	})
end
